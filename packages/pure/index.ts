...
import type { UserInputConfig } from './types/user-config';
...
import { UserConfigSchema } from './types/user-config';
	...
	return {
		...
		hooks: {
			'astro:config:setup': async ({ config, updateConfig }) => {
				...
				if (userConfig.integ.mediumZoom.enable) remarkPlugins.push([remarkAddZoomable, userConfig.integ.mediumZoom.options]);
