...
export const ThemeConfigSchema = () =>
	z.object({
		...
		title: z.string().describe('Title for your website. Will be used in metadata and as browser tab title.'),
		...
		titleDelimiter: z.string().describe('Will be used as title delimiter in the generated `<title>` tag.').default('•'),
		 ...
		 * npmCDN: 'https://esm.sh'
		 */
		npmCDN: z.string().default('https://esm.sh').describe('The npm CDN to use for loading npm packages.'),
		...
		footer: z.object({
			...
			credits: z.boolean().default(true).describe('Enable displaying a “Built with Starlight” link in your site’s footer.'),
