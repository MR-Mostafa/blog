...
export const theme: ThemeUserConfig = {
	...
	description: 'بلاگ فنی با تمرکز بر توسعه فرانت‌اند، تایپ‌اسکریپت و ری‌اکت. آموزش‌ها، نکات، و تکنیک‌های پیشرفته برای توسعه‌دهندگان وب.',
...
export const integ: IntegrationUserConfig = {
	...
	typography: {
		...
		class: 'break-words prose prose-pure dark:prose-invert dark:prose-pure prose-headings:font-medium',
	},
